		...
		if (!isLock) {
			if (fruitName != null && fruitQty != null && _Line != null) {
				...
				for (int i = 0; i < _Line; i++) {
					int n=0;
					if(fruitName[i]=="BoxOrange"){n = 3;}
					else if(fruitName[i]=="BoxCarrot"){n = 0;}
					else if(fruitName[i]=="BoxPineapple"){n = 4;}
					else if(fruitName[i]=="BoxGrape"){n = 1;}
					else if(fruitName[i]=="BoxMango"){n = 2;}
