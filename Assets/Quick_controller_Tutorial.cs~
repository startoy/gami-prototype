...
public class Quick_controller_Tutorial : MonoBehaviour {
			...
			if (right == left) {
				...
				if (clickDetech (right)) {
					...
					if (left == 0 && right == 0 && pivot == 2) {
						chooseRight = false;
						chooseLeft = true;
					}else if(left == 4 && right == 4 && pivot == 5){
						oranges [5].transform.tag = "sorted";
						oranges [4].transform.tag = "sorted";
						oranges [3].transform.tag = "sorted";
						pivot = 5;
						right = 5;
						left = 5;
						currentPointing (); //moving LRP
...
//						else if(left==0 && right == 0 && pivot== 2){
//							oranges [right].transform.tag = "sorted";
//							oranges [1].transform.tag = "sorted";
//							pivot = 5;
//							right = 4;
